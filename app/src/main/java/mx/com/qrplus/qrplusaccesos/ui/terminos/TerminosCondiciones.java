package mx.com.qrplus.qrplusaccesos.ui.terminos;
...
public class TerminosCondiciones extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.fragment_terminos_condiciones, container, false);
        ejecutaTerminosycondiciones();
        TerminosYCondiciones = view.findViewById(R.id.text);
        return view;
    }
...
//                Parameters
                ...
                request.addProperty("Tipo_Doc", "2");
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                TerminosYCondiciones.setText(cuerpo);
